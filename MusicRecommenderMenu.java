...
public class MusicRecommenderMenu {
    ...
    public static void main(String[] args) {
        ...
        int beatsPerMinute = scan.nextInt();
        System.out.println("Do you like popular music? (Y/N)");
        scan.nextLine();
        boolean likePopular = (scan.nextLine().equalsIgnoreCase("Y"));
        MusicProfile musicProfile = new MusicProfile(name, artist, genre, beatsPerMinute, likePopular);
        ...
        while (option != 5) {
            ...
            switch (option) {
                ...
                case 3 -> {
                    try {
                        System.out.println(musicRecommender
                                .beatsPerMinuteBasedRecommendation(musicProfile).toString());
                    } catch (NoRecommendationException e) {
                        System.out.println(e.getMessage());
                    }
                }
